...
struct unsq_eve_any_of_default_any_128_1 {
  const char* name() const { return "unsq_eve::any_of<128, 1, default_any>"; }
...
struct unsq_eve_any_of_default_any_256_1 {
  const char* name() const { return "unsq_eve::any_of<256, 1, default_any>"; }
...
struct unsq_eve_any_of_default_any_256_4 {
  const char* name() const { return "unsq_eve::any_of<256, 4, default_any>"; }
...
int main(int argc, char** argv) {
  bench::bench_main<bench::find_0_bench</*unsq_eve_any_of_default_any_128_1,
                                        unsq_eve_any_of_default_any_256_1,*/
                                        unsq_eve_any_of_default_any_256_4>>(
      argc, argv);
}
